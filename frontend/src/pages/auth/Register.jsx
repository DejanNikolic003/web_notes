		...
		<div className="min-h-screen bg-slate-900 px-4 py-10 text-slate-100">
			<div className="mx-auto max-w-md">
				<div className="mb-6 text-center">
					...
					<p className="mt-1 text-slate-400">Start taking better notes today</p>
				</div>
				<div className="rounded-xl border border-slate-800 bg-slate-800/60 p-6 shadow-lg shadow-slate-950/30">
					...
					<form onSubmit={handleSubmit} className="space-y-4">
						...
						<button type="submit" className="w-full rounded-lg bg-sky-500 px-4 py-2 text-sm font-medium text-white shadow-sm ring-1 ring-sky-400/30 transition hover:bg-sky-600 focus:outline-none focus:ring-2 focus:ring-sky-400/60">Create account</button>
					</form>
				</div>
			</div>
		</div>
